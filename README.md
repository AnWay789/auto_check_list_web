...
Система автоматизированной проверки дашбордов через Telegram-бота. Django-бэкенд по расписанию отправляет списки дашбордов в бота; каждый дашборд имеет ссылку для отслеживания переходов (редирект на реальный дашборд).
