...
if DATABASE_URL:
    # Используем PostgreSQL из переменной окружения (для Docker)
    try:
        ...
        # Fallback на SQLite если dj_database_url не установлен
        DATABASES = {
            'default': {
...
DJANGO_EXTERNAL_URL = os.environ.get("DJANGO_EXTERNAL_URL", "localhost:8000")
